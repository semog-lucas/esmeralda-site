...
export const metadata: Metadata = {
  title: "Blog |  Insights e Conhecimento Técnico",
  description: "Explore artigos técnicos, tendências de tecnologia, automação e inovação sustentável. Conteúdo especializado para desenvolvedores e entusiastas de tecnologia.",
  keywords: [
    "blog tecnologia",
    "desenvolvimento web",
    "next.js",
  ...
  openGraph: {
    title: "Blog | - Insights e Conhecimento Técnico",
    description: "Artigos técnicos, tendências de tecnologia e inovação sustentável.",
    url: "/blog",
    siteName: "Esmeralda",
    locale: "pt_BR",
    type: "website",
